...
normal_bindings = {
    ...
    "zll": "spawn -u qute-pass -d tofi",
    "zlL": "spawn -u qute-pass -d tofi --unfiltered",
    "zlu": "spawn -u qute-pass -d tofi --username-only",
    "zlU": "spawn -u qute-pass -d tofi --unfiltered --username-only",
    "zlp": "spawn -u qute-pass -d tofi --password-only",
    "zlP": "spawn -u qute-pass -d tofi --unfiltered --password-only",
    "zlo": "spawn -u qute-pass -d tofi --otp-only",
    "zlO": "spawn -u qute-pass -d tofi --unfiltered --otp-only",
    "zm": "spawn umpv {url}",
